 ...
 * @category ParticipateGuild
 * @category generated
 */
export const participateGuildStruct = new beet.BeetArgsStruct<{
  instructionDiscriminator: number[] /* size: 8 */
}>(
  [['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)]],
  'ParticipateGuildInstructionArgs'
)
/**
 * Accounts required by the _participateGuild_ instruction
 *
 ...
 * @category generated
 */
export type ParticipateGuildInstructionAccounts = {
...
export const participateGuildInstructionDiscriminator = [
  130, 233, 156, 219, 121, 211, 224, 32,
]

/**
 * Creates a _ParticipateGuild_ instruction.
 *
 ...
 * @category generated
 */
export function createParticipateGuildInstruction(
  accounts: ParticipateGuildInstructionAccounts,
  programId = new web3.PublicKey('HuntaX1CmUt5EByyFPE8pMf13SpvezybmMTtjmpmGmfj')
) {
  const [data] = participateGuildStruct.serialize({
    instructionDiscriminator: participateGuildInstructionDiscriminator,
  })
